...
public class Distributor2Market extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_distributor2_market);

        requestQueue = Volley.newRequestQueue(Distributor2Market.this);
        ...
        market_status_heading.setText("Market status of users under "+getIntent().getStringExtra("username"));


        market_status_recycler = findViewById(R.id.match_market_recycler);
        market_status_recycler.setLayoutManager(new LinearLayoutManager(Distributor2Market.this , LinearLayoutManager.VERTICAL , false));
    ...
    private void get_market_status()
    {
        ...
        try {
            ...
            jsonObject.put("module" , "market status of distributor2");
